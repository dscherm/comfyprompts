...
- [ ] **D0.11** List **`soapbox_world`** (post-apocalyptic wasteland scenes/vehicles) LoRA **FREE** on CivitAI. *(Companion to soapbox_racers — the 2nd of the two-LoRA split. Trained 2026-07-01 on 38 game cutscenes + 7 karts. Eval + listing pending training completion. FREE only, Flux-dev license.)*
