...
- [ ] **L0.3** Build the piece library — ~25-30 modular retro-futurist pieces (towers ×N, domes, slabs/shops w/ neon signs, skybridges, hover-vehicles, pylons/streetlights, ground/road tiles, billboards), DissonantDreams palette, flat-shaded low-poly.
- [ ] **L0.4** Export GLB + OBJ + FBX per piece (mirror the village-kit export).
