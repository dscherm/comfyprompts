...
from comfyui_agent_sdk.assets import encode_preview_for_mcp
from mcp_helpers import fetch_asset_bytes, get_cache_key
...
def register_and_build_response(
    ...
    Args:
        ...
        webhook_manager: Optional WebhookManager for dispatching generation_completed events
    ...
    # Dispatch generation_completed webhook event
    if webhook_manager:
        try:
            webhook_manager.dispatch("generation_completed", {
                "tool": tool_name or workflow_id,
                "asset_id": asset_record.asset_id,
                "workflow_id": workflow_id,
