...
**Nature (4):** pine tree, tree stump, rock cluster, bush.
...
palisade, bridge, and ground pieces tile edge-to-edge; rotate in 90° steps.

## Use
- **Godot 4 / Unity / Unreal / Blender:** import the GLB (or FBX). Drop on a grid.
- Pairs with **GrimForge Village Vol. 1** (28 pieces) — see `hero.png` for an
  assembled village using both volumes.

## Style
GrimForge dark-fantasy palette: weathered timber, mossy/ruined stone, slate &
thatch, muted earth, with torch-orange glow. Pairs with the GrimForge concept-art
LoRA and texture pack.

## License
Royalty-free for personal & commercial projects. Do not resell/redistribute the
raw kit files. Procedurally generated; no third-party IP.

*`hero.png` = combined Vol.1 + Vol.2 village · `catalog.png` = the 23 new pieces.*
