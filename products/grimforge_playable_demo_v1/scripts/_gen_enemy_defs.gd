...
# id, kind, target_h, hp, dmg, world, home_x, home_z
const ROWS := [
	["skeleton_warrior", "biped", 0.80, 30.0, 9.0, "courtyard", 0.7, 3.0],
	["ghoul", "biped", 0.75, 40.0, 12.0, "courtyard", -4.0, 1.5],
	["plague_zombie", "biped", 0.78, 35.0, 9.0, "courtyard", -2.5, -2.0],
	["imp", "biped", 0.50, 20.0, 9.0, "courtyard", 4.0, 2.2],
	["bone_hound", "quad", 0.45, 30.0, 9.0, "courtyard", 3.0, -2.5],
	["bone_golem", "biped", 1.10, 80.0, 18.0, "interior", 0.0, 1.5],
	["cultist", "biped", 0.80, 25.0, 9.0, "interior", -1.6, 2.5],
	["necromancer", "biped", 0.85, 30.0, 9.0, "interior", 0.0, -3.0],
	["skeleton_mage", "biped", 0.80, 45.0, 11.0, "interior", -2.0, -2.4],
	["lich_king", "biped", 0.95, 60.0, 15.0, "interior", 2.0, -2.4],
	["dire_rat", "quad", 0.25, 15.0, 6.0, "town", -1.5, -3.0],
	["hell_hound", "quad", 0.50, 40.0, 12.0, "town", 2.0, 0.5],
	["grave_boar", "quad", 0.45, 45.0, 14.0, "town", -3.0, 4.0],
]
